...
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Notion2API</title>
...
</head><body><div class="shell"><main><div class="brand"><span class="brand-dot"></span>Notion2API · Enterprise</div><h1>OpenAI-Compatible Notion AI Bridge</h1><p>Provides model listing, web search toggle, image/PDF/CSV attachment uploads, and a local WebUI admin console.</p><p>Admin panel at <code>/admin</code>, OpenAI-compatible API at <code>/v1/*</code>, health check at <code>/healthz</code>.</p><div class="links"><a class="primary" href="/admin"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12h18M13 5l7 7-7 7"/></svg>Open Console</a><a class="secondary" href="/v1/models"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h16M4 18h10"/></svg>Model List</a><a class="secondary" href="/healthz"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>Health Check</a></div><div class="meta"><span>service:notion2api</span><span class="dot"></span><span>protocol:openai-compatible</span><span class="dot"></span><span>ui:enterprise</span></div></main></div></body></html>`
